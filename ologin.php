...
<body>
  ...
  <div class="form-group">
     <input type="email" class="form-control" name="email" placeholder="E-mail ID"required/>
      ...
      <input class="btn btn-warning" name="ownerBtn" type="Submit" class="btn btn-default"value="LOGIN" >
      <a href="contact.php" style="font-size: medium;">Don't have an account?Contact us!</a>
      </form>
    </div>
  </div>
</body>
